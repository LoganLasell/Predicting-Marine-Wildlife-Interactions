...
Research Question: How does hook/set effort and species type correlate with the likelihood and intensity of protected or high species interactions? Can I implement a Bayesian Logistic Regression model to predict the probability of at least one protected or high-value species interaction using hook/set effort and species information from the MRIP survey data?
